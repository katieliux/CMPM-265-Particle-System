...
int main()
{
	...
	ParticleSystem particles(Vector2f(400.0f, 200.0f), 0.1f, 80.0f, 10.0f, 0.1f, 45.0f, 3, 0, 0);
	ParticleSystem particles2(Vector2f(800.0f, 200.0f), 0.3f, 60.0f, 30.0f, 0.08f, 10.0f, 2, 1, 1);
